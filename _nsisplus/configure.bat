...
(
  ...
  echo.
  echo set "NSIS_SETUP_DEV.SVN.REPOROOT=https://svn.code.sf.net/p/nsisplus/NsisSetupDev/trunk"
  echo set "NSIS_SETUP_LIB.SVN.REPOROOT=https://svn.code.sf.net/p/nsisplus/NsisSetupLib/trunk"
  echo set "NSIS_SETUP_SAMPLES.SVN.REPOROOT=https://svn.code.sf.net/p/nsisplus/NsisSetupSamples/trunk"
  echo.
